...
namespace MtconnectCore.Standard.Documents.Assets
{
    ...
    public class ProcessFeedRate : MtconnectNode
    {
        ...
        /// <inheritdoc />
        public ProcessFeedRate(XmlNode xNode, XmlNamespaceManager nsmgr, MtconnectVersions version) : base(xNode, nsmgr, version)
        {
        ...
        [MtconnectVersionApplicability(MtconnectVersions.V_1_2_0, "Part 4 Section 6.1.17")]
