...
namespace MtconnectCore.Standard.Contracts
{
    ...
    public class Observation
    {
        ...
        /// </summary>
        public virtual CategoryEnum Category { get; }
        ...
        public Observation(CategoryEnum category, string type, string subType = null)
        {
            Category = category;
            Type = type;
            SubType = subType;
        ...
        /// <summary>
        /// <inheritdoc cref="Observation(CategoryEnum, string, string)" />
        /// </summary>
        /// <param name="category"><inheritdoc cref="Category" path="/summary" /></param>
        /// <param name="type"><inheritdoc cref="Type" path="/summary" /></param>
        /// <param name="subType"><inheritdoc cref="SubType" path="/summary" /></param>
        public Observation(CategoryEnum category, Enum type, string subType = null) : this(category, type.ToString(), subType) { }
        /// <summary>
        /// <inheritdoc cref="Observation(CategoryEnum, string, string)" />
        /// </summary>
        /// <param name="category"><inheritdoc cref="Category" path="/summary" /></param>
        /// <param name="type"><inheritdoc cref="Type" path="/summary" /></param>
        /// <param name="subType"><inheritdoc cref="SubType" path="/summary" /></param>
        public Observation(CategoryEnum category, Enum type, Enum subType = null) : this(category, type, subType?.ToString()) { }
    }
    /// <summary>
    ...
    public class EventObservation : Observation
    {
        ...
        /// <inheritdoc cref="Observation(CategoryEnum, string, string)"/>
        public EventObservation(string type, string subType = null) : base(CategoryEnum.EVENT, type, subType) { }
        /// <inheritdoc cref="Observation(CategoryEnum, Enum, string)"/>
        public EventObservation(EventTypes type, string subType = null) : base(CategoryEnum.EVENT, type, subType) { }
        /// <inheritdoc cref="Observation(CategoryEnum, Enum, Enum)"/>
        public EventObservation(EventTypes type, Enum subType = null) : base(CategoryEnum.EVENT, type, subType) { }
    }
    /// <summary>
    ...
    public class SampleObservation : Observation
    {
        ...
        /// <inheritdoc cref="Observation(CategoryEnum, string, string)"/>
        public SampleObservation(string type, string subType = null) : base(CategoryEnum.SAMPLE, type, subType) { }
        /// <inheritdoc cref="Observation(CategoryEnum, Enum, string)"/>
        public SampleObservation(SampleTypes type, string subType = null) : base(CategoryEnum.SAMPLE, type, subType) { }
        /// <inheritdoc cref="Observation(CategoryEnum, Enum, Enum)"/>
        public SampleObservation(SampleTypes type, Enum subType = null) : base(CategoryEnum.SAMPLE, type, subType) { }
    }
}
