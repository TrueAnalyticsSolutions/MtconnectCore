...
namespace MtconnectCore.Standard.Contracts.Enums.Devices.Attributes
{
    ...
    public enum DataItemAttributes
    {
        ...
        /// </summary>
        [MtconnectVersionApplicability(MtconnectVersions.V_1_1_0, Constants.ModelBrowserLinks.DeviceModel.DATA_ITEM)]
        NATIVE_UNITS,
        /// <summary>
        ...
        /// </list>
        /// </summary>
        [MtconnectVersionApplicability(MtconnectVersions.V_1_2_0, Constants.ModelBrowserLinks.DeviceModel.DATA_ITEM)]
        STATISTIC,
        /// <summary>
        ...
        [MtconnectVersionApplicability(MtconnectVersions.V_1_0_1, Constants.ModelBrowserLinks.DeviceModel.DATA_ITEM, MtconnectVersions.V_2_0_0)]
        COORDINATE_SYSTEM,
        /// <summary>
        /// The identifier attribute of the <see cref="Composition"/> element that the reported data is most closely associated.
        /// </summary>
        [MtconnectVersionApplicability(MtconnectVersions.V_1_4_0, Constants.ModelBrowserLinks.DeviceModel.DATA_ITEM)]
        COMPOSITION_ID,
        /// <summary>
        ...
        /// </summary>
        [MtconnectVersionApplicability(MtconnectVersions.V_1_5_0, Constants.ModelBrowserLinks.DeviceModel.DATA_ITEM)]
        DISCRETE,
        /// <summary>
