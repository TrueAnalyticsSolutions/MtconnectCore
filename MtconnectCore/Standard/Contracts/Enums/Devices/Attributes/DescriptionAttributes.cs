...
namespace MtconnectCore.Standard.Contracts.Enums.Devices.Attributes
{
    ...
    [MtconnectVersionApplicability(MtconnectVersions.V_1_0_1, Constants.ModelBrowserLinks.DESCRIPTION)]
    public enum DescriptionAttributes
    {
        ...
        /// </summary>
        [MtconnectVersionApplicability(MtconnectVersions.V_1_2_0, Constants.ModelBrowserLinks.DESCRIPTION)]
        MODEL,
        /// <summary>
