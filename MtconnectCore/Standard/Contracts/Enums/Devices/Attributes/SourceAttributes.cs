...
namespace MtconnectCore.Standard.Contracts.Enums.Devices.Attributes
{
    ...
    /// </summary>
    [MtconnectVersionApplicability(MtconnectVersions.V_1_0_1, Constants.ModelBrowserLinks.DeviceModel.SOURCE)]
    public enum SourceAttributes
    {
        ...
        /// </summary>
        [MtconnectVersionApplicability(MtconnectVersions.V_1_2_0, Constants.ModelBrowserLinks.DeviceModel.SOURCE)]
        COMPONENT_ID,
        /// <summary>
        ...
        /// </summary>
        [MtconnectVersionApplicability(MtconnectVersions.V_1_4_0, Constants.ModelBrowserLinks.DeviceModel.SOURCE)]
        COMPOSITION_ID,
        /// <summary>
