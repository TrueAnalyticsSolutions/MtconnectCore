...
{
    [MtconnectVersionApplicability(MtconnectVersions.V_1_7_0, Constants.ModelBrowserLinks.DeviceModel.SOLID_MODEL)]
    public enum SolidModelAttributes
    {
        ...
        /// </summary>
        [MtconnectVersionApplicability(MtconnectVersions.V_2_0_0, Constants.ModelBrowserLinks.DeviceModel.SOLID_MODEL)]
        NATIVE_UNITS,
        /// <summary>
