...
namespace MtconnectCore.Standard.Contracts.Enums.Devices.Attributes
{
    ...
    [MtconnectVersionApplicability(MtconnectVersions.V_1_6_0, Constants.ModelBrowserLinks.DeviceModel.SPECIFICATION)]
    public enum SpecificationAttributes {
        ...
        /// </summary>
        [MtconnectVersionApplicability(MtconnectVersions.V_1_7_0, Constants.ModelBrowserLinks.DeviceModel.SPECIFICATION)]
        ID,
        /// <summary>
