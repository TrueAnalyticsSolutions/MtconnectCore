...
namespace MtconnectCore.Standard.Contracts.Enums.Devices.Attributes
{
    ...
    [MtconnectVersionApplicability(MtconnectVersions.V_1_3_0, Constants.ModelBrowserLinks.REFERENCE)]
    public enum ReferenceAttributes {
        ...
        /// </summary>
        [MtconnectVersionApplicability(MtconnectVersions.V_1_4_0, Constants.ModelBrowserLinks.REFERENCE)]
        ID_REF,
        /// <summary>
        ...
        /// </summary>
        [MtconnectVersionApplicability(MtconnectVersions.V_1_3_0, Constants.ModelBrowserLinks.REFERENCE, MtconnectVersions.V_1_4_0)]
        DATA_ITEM_ID,
        /// <summary>
        /// pointer to the  DataItem::id that contains the information to be associated with this entity.
        /// </summary>
