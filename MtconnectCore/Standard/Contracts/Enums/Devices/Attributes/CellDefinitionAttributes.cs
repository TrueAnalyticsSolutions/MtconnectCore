...
namespace MtconnectCore.Standard.Contracts.Enums.Devices.Attributes
{
    public enum CellDefinitionAttributes
    {
        ...
        /// </summary>
        [MtconnectVersionApplicability(MtconnectVersions.V_1_6_0, Constants.ModelBrowserLinks.CELL_DEFINITION)]
        UNITS,
        /// <summary>
        ...
        /// </summary>
        [MtconnectVersionApplicability(MtconnectVersions.V_1_7_0, Constants.ModelBrowserLinks.CELL_DEFINITION)]
        SUB_TYPE,
        /// <summary>
